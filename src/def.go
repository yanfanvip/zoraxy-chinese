...
var (
	webUIPort                  = flag.String("port", ":8000", "Management web interface: port (e.g. :8000) or 'socket' for Unix socket")
	webUISocket                = flag.String("socket", "/run/zoraxy.socket", "Unix socket filename or absolute path for management web interface when -port=socket")
